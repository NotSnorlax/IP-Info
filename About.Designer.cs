namespace IPgrab
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "About IP Info";
			// 
			// label2
			// 
			...
			this.label2.Text = "Information about IP Info";
			// 
			// button1
			// 
			...
			this.label7.Text = "NotSnorlax(Gruby) - Program\r\nFikuSystems (Fiku_, Rudy) - UI";
			// 
			// label6
			// 
    ...
    "ibuters:";
			...
			// pictureBox1
			// 
			this.pictureBox1.Image = global::IPInfo.Properties.Resources.ipgrabiconbig;
